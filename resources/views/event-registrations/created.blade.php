<x-guest-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center bg-gray-100">
        <div class="w-full  sm:max-w-xl bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <p class="px-4 sm:px-6 my-3 text-base text-gray-700">Gezellig dat je mee eet op woensdagavond {{ $eventRegistration->DinnerEvent["date"]->translatedFormat('j F Y') }}!</p>

        ...
        <div class="w-full  sm:max-w-xl bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                <h3 class="text-lg leading-6 font-bold text-gray-900">Samen eten op de
                    woensdagavond {{ $dinnerEvent["date"]->format('j F Y') }}</h3>
            </div>
            ...
            <p class="px-4 sm:px-6 my-3 text-base text-gray-700">Leuk dat je wilt gaan koken op woensdagavond {{ $dinnerEvent["date"]->format('j F Y') }}!
            </p>
            <p class="px-4 sm:px-6 my-3 text-base text-gray-700">
                Je aanmelding is nu <strong>definitief</strong> en iedereen kan zich tot {{ $dinnerEvent["registration_deadline"]->format('j F Y H:m') }} inschrijven voor jouw maaltijd.
            </p>
            <p class="px-4 sm:px-6 my-3 text-base text-gray-700">

    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center bg-gray-100">
        ...
        <div class="w-full  sm:max-w-xl bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <h4 class="px-4 sm:px-6 py-2 mt-4 text-md font-semibold text-gray-900">Hoi <span
                    class="text-2xl align-middle">👩‍🍳</span> {{ $cookName }},</h4>

            <p class="px-4 sm:px-6 my-3 text-base text-gray-700">Leuk dat je wilt gaan koken op woensdagavond {{ $nextWednesday["date"]->format('j F Y') }}!
            </p>
